...
# from recruit.models import Application
...
class Quiz(models.Model):
    ...
    applicationc = models.OneToOneField(
        "recruit.Application", null=True, blank=True,
        verbose_name=_("applicationc"), on_delete=models.CASCADE)

    historyx = models.ForeignKey(
        "recruit.History", null=True, blank=True,
        verbose_name=_("history"), on_delete=models.CASCADE)
...
class Sitting(models.Model):
    ...
    # current_score_percent = models.IntegerField(verbose_name=_("Current Score in %"))
    # exam_passed_status = models.BooleanField(verbose_name=_("Current Score in %"), default = False )
    ...
    interview_status = models.CharField(choices=EXAM_RESULT, default=EXAM_RESULT[0][0], max_length=100 )
...
class Question(models.Model):
    ...
    applications = models.ForeignKey(
        "recruit.Application", null=True, blank=True,
        verbose_name=_("applicationx"), on_delete=models.CASCADE)
